...
final class Store: ObservableObject {
    ...
    private let fileName = "studybreak_entries.json"
    ...
    static func seedData() -> [Entry] {
        let now = Date()
        return [
            Entry(title: "Sample Session One", detail: "First example entry.", date: now),
            Entry(title: "Sample Session Two", detail: "Second example entry.", date: now.addingTimeInterval(-86400)),
            Entry(title: "Sample Session Three", detail: "Third example entry.", date: now.addingTimeInterval(-172800)),
        ]
    }
}
